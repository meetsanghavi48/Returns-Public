    ...
    try {
      await fetch("https://api.sendgrid.com/v3/mail/send", {
        ...
        body: JSON.stringify({
          ...
          from: { email: "returns@blakc.in", name: "Returns Manager" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 24 }}>
        <div>
          ...
          <div className="admin-card" style={{ marginBottom: 16, padding: 16 }}>
            ...
            {showPreview ? (
              <div style={{ border: "1px solid #e5e7eb", borderRadius: 8, padding: 20, background: "#fafafa", minHeight: 300 }} dangerouslySetInnerHTML={{ __html: previewHtml }} />
            ) : (
              <textarea
