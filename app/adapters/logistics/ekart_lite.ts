...
export class EkartLiteAdapter extends LogisticsAdapter {
  readonly key = "ekart_lite";
  readonly displayName = "Ekart Lite";
  readonly region = "IN";
  ...
  async createPickup(_params: PickupParams, _credentials: Record<string, string>): Promise<PickupResult> {
    throw new Error("Ekart Lite integration coming soon.");
  }
