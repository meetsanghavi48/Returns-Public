...
export class EShipperAdapter extends LogisticsAdapter {
  readonly key = "eshipper";
  readonly displayName = "eShipper";
  readonly region = "CA";
  readonly logoUrl = "https://www.google.com/s2/favicons?domain=eshipper.com&sz=64";
  ...
  async createPickup(_params: PickupParams, _credentials: Record<string, string>): Promise<PickupResult> {
    throw new Error("eShipper integration coming soon.");
  }
