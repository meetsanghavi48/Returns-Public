...
export class FulfillmentToolsAdapter extends LogisticsAdapter {
  readonly key = "fulfillment_tools";
  readonly displayName = "Fulfillment Tools";
  readonly region = "EU";
  readonly logoUrl = "https://www.google.com/s2/favicons?domain=fulfillmenttools.com&sz=64";
  ...
  async createPickup(_params: PickupParams, _credentials: Record<string, string>): Promise<PickupResult> {
    throw new Error("Fulfillment Tools integration coming soon.");
  }
