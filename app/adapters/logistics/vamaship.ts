...
export class VamashipAdapter extends LogisticsAdapter {
  readonly key = "vamaship";
  readonly displayName = "Vamaship";
  readonly region = "IN";
  readonly logoUrl = "https://www.google.com/s2/favicons?domain=vamaship.com&sz=64";
  ...
  async createPickup(_params: PickupParams, _credentials: Record<string, string>): Promise<PickupResult> {
    throw new Error("Vamaship integration coming soon.");
  }
