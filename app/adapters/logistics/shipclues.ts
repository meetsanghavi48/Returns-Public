...
export class ShipcluesAdapter extends LogisticsAdapter {
  readonly key = "shipclues";
  readonly displayName = "Shipclues";
  readonly region = "IN";
  readonly logoUrl = "https://www.google.com/s2/favicons?domain=shipclues.com&sz=64";
  ...
  async createPickup(_params: PickupParams, _credentials: Record<string, string>): Promise<PickupResult> {
    throw new Error("Shipclues integration coming soon.");
  }
