...
export class ShipmondoAdapter extends LogisticsAdapter {
  readonly key = "shipmondo";
  readonly displayName = "Shipmondo";
  readonly region = "EU";
  readonly logoUrl = "https://www.google.com/s2/favicons?domain=shipmondo.com&sz=64";
  ...
  async createPickup(_params: PickupParams, _credentials: Record<string, string>): Promise<PickupResult> {
    throw new Error("Shipmondo integration coming soon.");
  }
