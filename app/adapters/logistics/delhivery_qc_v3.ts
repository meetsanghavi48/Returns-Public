...
export class DelhiveryQCV3Adapter extends LogisticsAdapter {
  readonly key = "delhivery_qc_v3";
  readonly displayName = "Delhivery QC V3";
  readonly region = "IN";
  ...
  async createPickup(_params: PickupParams, _credentials: Record<string, string>): Promise<PickupResult> {
    throw new Error("Delhivery QC V3 integration coming soon.");
  }
